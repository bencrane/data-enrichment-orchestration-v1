...
export default function CrmDataPastUploadsPage() {
  const params = useParams();
  const clientId = params.id as string;

  const [client, setClient] = useState<Client | null>(null);
  const [uploads, setUploads] = useState<CrmDataUpload[]>([]);
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-zinc-500 dark:text-zinc-400">
                {client.company_name} - Previous CRM Data CSV uploads
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-2xl mx-auto">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                View and manage previous CRM Data CSV uploads
              </CardDescription>
            </CardHeader>
            <CardContent>
              {uploads.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <Link
                    href={`/clients/${clientId}/crm-data/upload`}
