          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-zinc-500 dark:text-zinc-400">
                {client.company_name} - CRM Data workstream
              </p>
            </div>
          </div>
        </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  <div>
                    ...
                    <input
                      ...
                      placeholder="e.g., CRM Data Enrichment"
                      className="w-full px-3 py-2 border border-zinc-300 dark:border-zinc-600 rounded-md bg-white dark:bg-zinc-800 text-zinc-900 dark:text-zinc-100 text-sm focus:outline-none focus:ring-2 focus:ring-rose-500"
                    />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-1">
                    ...
                    <input
                      ...
                      placeholder="e.g., Enrich CRM export data"
                      className="w-full px-3 py-2 border border-zinc-300 dark:border-zinc-600 rounded-md bg-white dark:bg-zinc-800 text-zinc-900 dark:text-zinc-100 text-sm focus:outline-none focus:ring-2 focus:ring-rose-500"
                    />
                  </div>
                </div>
                          ...
                          <button
                            ...
                            className={`w-full text-left p-3 rounded-md transition-colors ${
                              isAdded
                                ...
                                : "hover:bg-rose-50 dark:hover:bg-rose-900/20 border border-transparent hover:border-rose-200 dark:hover:border-rose-800"
                            }`}
                          >
                        ...
                        <div className="space-y-2">
                          {pipeline.map((slug, index) => {
                            ...
                            return (
                              ...
                              >
                                <div className="flex-shrink-0 w-6 h-6 rounded-full bg-rose-100 dark:bg-rose-900 text-rose-700 dark:text-rose-300 flex items-center justify-center text-xs font-bold">
                                  {index + 1}
                                </div>
                                <div className="flex-1 min-w-0">
