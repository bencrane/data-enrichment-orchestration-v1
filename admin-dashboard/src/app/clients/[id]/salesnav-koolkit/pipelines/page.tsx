...
export default function SalesNavKoolKitPipelinesPage() {
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-zinc-500 dark:text-zinc-400">
                {client.company_name} - Define workflow sequences for SalesNav KoolKit
              </p>
            </div>
          </div>
        </div>
      ...
      <main className="container mx-auto px-6 py-8">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Define and save workflow sequences for SalesNav KoolKit enrichment
            </CardDescription>
          </CardHeader>
          <CardContent>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  <div>
                    ...
                    <input
                      ...
                      placeholder="e.g., SalesNav Lead Enrichment"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder="e.g., Enrich leads with company data"
                      className="w-full px-3 py-2 border border-zinc-300 dark:border-zinc-600 rounded-md bg-white dark:bg-zinc-800 text-zinc-900 dark:text-zinc-100 text-sm focus:outline-none focus:ring-2 focus:ring-purple-500"
                    />
                  </div>
                </div>
