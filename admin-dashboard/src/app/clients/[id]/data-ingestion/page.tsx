      ...
      <main className="container mx-auto px-6 py-8 max-w-5xl">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Select a workstream to upload, configure, and manage enrichment pipelines
            </CardDescription>
          </CardHeader>
          <CardContent>
                  ...
                  {workstreams.map((workstream) => (
                    ...
                    >
                      <TableCell className="p-0">
                        <Link
                          href={`/clients/${clientId}/${getWorkstreamRoutePath(workstream.slug)}`}
                      ...
                      <TableCell className="p-0">
                        <Link
                          href={`/clients/${clientId}/${getWorkstreamRoutePath(workstream.slug)}`}
                          className="block px-4 py-4 text-zinc-500"
                        >
