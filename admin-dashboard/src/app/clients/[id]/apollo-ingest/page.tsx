...
export default function ApolloIngestPage() {
  ...
  useEffect(() => {
    async function fetchData() {
      setLoading(true);
      const [clientData, uploadsData, pipelinesData, configsData] = await Promise.all([
    ...
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-zinc-500 dark:text-zinc-400">
                {client.company_name} - Upload Apollo exports, configure enrichment pipelines, and manage workflow settings
              </p>
            </div>
          </div>
        </div>
      ...
      <main className="container mx-auto px-6 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {/* Upload Files */}
          <Link href={`/clients/${clientId}/apollo-ingest/upload`}>
          ...
          {/* Past Uploads */}
          <Link href={`/clients/${clientId}/apollo-ingest/uploads`}>
            <Card className="cursor-pointer hover:border-zinc-400 dark:hover:border-zinc-500 transition-colors h-full">
              <div className="p-6 flex flex-col items-center justify-center text-center min-h-[160px]">
          ...
          <Link href={`/clients/${clientId}/apollo-ingest/config`}>
            <Card className="cursor-pointer hover:border-zinc-400 dark:hover:border-zinc-500 transition-colors h-full">
              <div className="p-6 flex flex-col items-center justify-center text-center min-h-[160px]">
